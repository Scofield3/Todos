...
/*{
  ...
  //1. packageToRequire util function
  //2. error handle - vizualizirane na greshkata
  //3. foreign key - status za vsqko todo. get status and all other possible statuses (from DB or kadeto stoqt foreign keys - malko reaserach)
console.log("START");
requirejs.config({
    baseUrl: '../',
    nodeRequire : require,
    paths: {
        ...
        //"ajv-formats": 'node_modules/ajv-formats/dist/index',
...
requirejs(['jquery', 'lodash', 'validation'], function($, _, validation) {
    $(function () {
        //const validation = require("./validation");
